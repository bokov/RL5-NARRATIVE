...
Though Dr. Shireman's and Dr. Espinoza's Pilot Project and the grant proposals that developed from it are centered around the RAI-A, for my own project I intend to apply what I learned to the Rockwood index which is more robust than RAI-A, is used by both geriatricians and surgeons [todo] 