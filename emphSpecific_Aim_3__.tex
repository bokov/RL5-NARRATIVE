...
\begin{itemize}
\item To build on the EMR geocoding work I have done already to match patient address histories to the addresses of nursing homes and hospices, so that the transition from 
\
\end{itemize}
