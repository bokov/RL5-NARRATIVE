...
\emph{Specific Aim 1:} To finish development and internal validation of the preliminary Rockwood Index I developed using NSQIP data, includ.
\emph{Specific Aim 2:} To link our NSQIP dataset to long-term outcomes that are relevant to healthy aging as well as to socioeconomic covariates and then establish that:
\begin{itemize}
\item The Rockwood Index is 
\end{itemize}
