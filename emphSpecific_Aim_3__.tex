...
However, ACS NSQIP can be a good proving ground for algorithms that can then be migrated to raw EMR data: first, a frailty measure already validated on registry data