...
\item To determine whether the Rockwood Index is effective in predicting other well-established sequelae of frailty (falls and lower limb fractures, pneumonia, outp) beyond the surgical context of NSQIP.
\end{itemize}
