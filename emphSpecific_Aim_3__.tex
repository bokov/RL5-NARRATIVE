...
However, ACS NSQIP can be a good proving ground for algorithms that can then be migrated to raw EMR data: first, a copy of a health-system's local NSQIP registry is obtained \textit{with} patient identifiers still included (as I have done while supporting Dr. Shireman's Pepper Center Pilot project on predictors of frailty in )