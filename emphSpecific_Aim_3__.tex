...
\item Validate and refine the address-matching rules using as a standard the 554 patients discharged to non-community living who have full records in both the EMR and NSQIP to validate 
\end{itemize}
