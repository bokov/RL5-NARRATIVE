...
Though Dr. Shireman's and Dr. Espinoza's Pilot Project and the grant proposals that developed from it are centered around the RAI-A, for my own project I intend to apply what I learned to the Rockwood Index which is more robust than RAI-A, is in use by both geriatricians and surgeons [todo: find refs], and has a statistically sound grounding in the theory of gerontology \cite{Mitnitski_2001}. Briefly, a patient's Rockwood Index can be used to construct a hazard model similar to the Gompertz function .