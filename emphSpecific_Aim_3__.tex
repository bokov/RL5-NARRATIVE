...
This year linked the addresses of over 800,000 (75\%) of the patients from the combined UHS/UT Health population to census block groups and then use that to assign an estimated median household income to each of these patients. 
