...
\item To determine whether the Rockwood Index is effective in predicting other well-established sequelae of frailty (falls and lower limb fractures, pneumonia, outpatient readmissions, and death) in a the larger population of the EMR .
\end{itemize}
