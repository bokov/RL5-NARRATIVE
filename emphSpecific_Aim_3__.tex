...
This year I linked the addresses of over 800,000 (75\%) of the patients from the combined UHS/UT Health population to census block groups and then used those census block group to assign an estimated median household income to each of those patients. The i2b2 data warehouse that I helped create also contains long-term mortality data on 5971 patients as recorded in the EMR system and 8406 additional patients from social security data that would not
