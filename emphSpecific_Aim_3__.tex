...
The modified frailty index (mFI, a variant of the Rockwood Index which uses 11 variables from the American College of Surgeons NSQIP registry, has been effectively used to predict complications for many different types of surgery \cite{Uppal_2015,Tsiouris_2013,Bellamy_2017,22491599,23711971,23949353}. Registries such as ACS NSQIP offer the advantage of curated data with 
