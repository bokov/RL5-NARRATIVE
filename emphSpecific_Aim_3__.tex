...
This year linked the addresses of over 800,000 (75\%) of the patients from the combined UHS/UT Health population to census block groups and from there, infer the median household income for each of them. For the NSQIP 
