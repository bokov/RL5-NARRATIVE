...
\item I will determine whether the predictions and parameter distributions are stable under resampling. I will then further validate my predictive model against the hold-out validation subsets
