...
A Cox proportional hazard model with RAI-A as the predictor and number of days from surgery until either death or readmission with a 30-day followup reports a sign
