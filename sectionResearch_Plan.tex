...
The work I propose will create the means by which mFI, a frailty measure used by geriatricians as well as surgeons, could be calculated for any patient, not only those selecti without relying on an in-person assessment, performance test, or questionnaire.
